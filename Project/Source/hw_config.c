...
uint32_t CDC_Packet_TargetLaserT(void)
{
	...
	if(ScreenState.TargetInfomation.KD1_Ptr != NULL)
	{
		...
		CDC_Send_length = sprintf((char*)CDC_SendBuffer,"靶1(%X):[LaserT:%10.5f℃ SkyLum:%4u]\r\n",address_KDx,temperature_KDx,skyluminance_KDx);
	}
	...
	if(ScreenState.TargetInfomation.KD2_Ptr != NULL)
	{
		...
		CDC_Send_length += sprintf((char*)&CDC_SendBuffer[CDC_Send_length],"靶2(%X):[LaserT:%10.5f℃ SkyLum:%4u]\r\n",address_KDx,temperature_KDx,skyluminance_KDx);
	}
	...
	if(ScreenState.TargetInfomation.KD3_Ptr != NULL)
	{
		...
		CDC_Send_length += sprintf((char*)&CDC_SendBuffer[CDC_Send_length],"靶3(%X):[LaserT:%10.5f℃ SkyLum:%4u]\r\n",address_KDx,temperature_KDx,skyluminance_KDx);
	}
	...
	if(ScreenState.TargetInfomation.KD4_Ptr != NULL)
	{
		...
		CDC_Send_length += sprintf((char*)&CDC_SendBuffer[CDC_Send_length],"靶4(%X):[LaserT:%10.5f℃ SkyLum:%4u]\r\n",address_KDx,temperature_KDx,skyluminance_KDx);
	}
